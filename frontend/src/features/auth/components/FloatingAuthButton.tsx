        ...
        <div className="fixed bottom-6 right-6 z-50">
            <div className="relative">
                ...
                <button
                    ...
                    className={`flex items-center px-4 py-3 rounded-lg shadow-lg font-medium transition-all duration-200 ${!isOnline
                ...
                {!isOnline && (
                    <div className="absolute bottom-full right-1/2 transform translate-x-1/2 mb-2 px-3 py-1 bg-gray-800 text-white text-xs rounded-md whitespace-nowrap">
