...
namespace Core.Interfaces
{
    ...
    {
        Task<SharedPokemon?> CreateSinglePokemonShareAsync(int userId, int pokeApiId, string? title = null, string? description = null, DateTime? expiresAt = null, int? maxViews = null);
